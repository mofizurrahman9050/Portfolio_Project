    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-lg-3 col-sm-6">
                ...
                <hr>
                <p class="footer-text"><i class="fas fa-map-marker-alt"></i>পুরাতন কসবা,কাজী পাড়া, যশোর। </p>
                <p class="footer-text"><i class="fas fa-phone"></i>০১৯১১৯৪৯০৫০</p>
                <p class="footer-text"><i class="fas fa-envelope"></i>marufrahman72@gmail.com</div>
            <div class="col-md-3 col-lg-3 col-sm-6">
            ...
            <div class="col-md-3 col-lg-3 col-sm-6">
                ...
                <hr>
                <a class="footer-link" target="_blank" href="{{url('/Policy')}}">প্রায়ভেসি পলিসি</a><br>
...
<div class="container-fluid bg-dark text-white m-0 text-center p-3">
    <p class="rights-text  my-2 ">সর্বস্বত্ব মফিজুর রহমান দ্বারা সংরক্ষিত; ২০২১ </p>
</div>